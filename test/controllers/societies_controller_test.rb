...
class SocietiesControllerTest < ActionController::TestCase
  ...
  test "should create society" do
    assert_difference('Society.count') do
      post :create, society: { description: @society.description, name: @society.name, register_num: @society.register_num, website: @society.website }
    end
  ...
  test "should update society" do
    patch :update, id: @society, society: { description: @society.description, name: @society.name, register_num: @society.register_num, website: @society.website }
    assert_redirected_to society_path(assigns(:society))
  end
